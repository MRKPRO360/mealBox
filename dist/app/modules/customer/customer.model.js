...
const customerAddressSchema = new mongoose_1.Schema({
    ...
    city: { type: String, enum: user_1.DIVISIONS, required: true },
...
const CustomerSchema = new mongoose_1.Schema({
    ...
    dietaryPreferences: {
        type: [String],
        enum: customer_constant_1.dietaryPreferences,
        default: ['Vegetarian'],
    },
    orderHistory: [{ type: mongoose_1.Schema.Types.ObjectId, ref: 'Order' }],
    selectedMeals: [{ type: mongoose_1.Schema.Types.ObjectId, ref: 'Meal' }],
    address: {
...
CustomerSchema.statics.isCustomerExistsById = function (id) {
