...
class QueryBuilder {
    ...
    filter() {
        ...
        if (queryObj.rating) {
            const min = parseFloat(Array.isArray(queryObj.rating)
                ? queryObj.rating[0]
                : queryObj.rating || '0');
            queryObj.rating = { $gte: min, $lt: min + 1 };
            this.modelQuery = this.modelQuery.find(Object.assign(Object.assign({}, queryObj), { rating: { $gte: min, $lt: min + 1 } }));
            return this;
        }
    ...
    sort() {
        var _a, _b, _c;
        const sortBy = (_a = this.query) === null || _a === void 0 ? void 0 : _a.sort;
        const order = (_c = (_b = this.query) === null || _b === void 0 ? void 0 : _b.order) === null || _c === void 0 ? void 0 : _c.toLowerCase();
        if (sortBy) {
    ...
    paginate() {
        ...
        const limit = ((_b = this === null || this === void 0 ? void 0 : this.query) === null || _b === void 0 ? void 0 : _b.limit) ? Number(this.query.limit) : null;
